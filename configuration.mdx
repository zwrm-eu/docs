...
| `primary_region` | string | `"local"` | Preferred deployment region |
...
<Tip>For sensitive values, use [`zwrm secrets`](/deploying/secrets) instead.</Tip>
...
See [Volumes](/deploying/volumes) for more details.
