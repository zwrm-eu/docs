...
If you use [Claude Code](https://docs.anthropic.com/en/docs/claude-code), install the ZWRM skills to manage your infrastructure directly from the AI assistant:
...
<CardGroup cols={2}>
  <Card title="Configuration" icon="gear" href="/apps/configuration">
