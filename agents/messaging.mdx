...
<Note>
Platform tools exist **only in autonomous [runs](/agents/runs)**. Interactive sessions — dashboard chat, the [OpenAI-compatible API](/agents/openai-api), SSH — don't get them: a live reader is already watching the conversation, so there is nothing to notify and nothing to sleep through.
</Note>
