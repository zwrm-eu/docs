...
For ZWRM cloud this is your platform URL; for [self-hosted](/self-hosting/overview) deployments it's your control plane's address.
...
```json
{ "error": "Not found", "message": "No app with that ID" }
```
