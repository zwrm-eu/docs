...
Build and deploy the application. [Guide →](/deploying/deploy)
...
Show application and machine status. [Guide →](/managing/status)
...
Scale to a target number of machines. [Guide →](/deploying/scaling)
...
Destroy machines or the entire application. [Guide →](/managing/destroy)
...
View or stream VM console output. [Guide →](/managing/logs)
...
SSH into a running VM. [Guide →](/managing/ssh)
...
Manage encrypted application secrets. [Guide →](/deploying/secrets)
...
Manage persistent volumes. [Guide →](/deploying/volumes)
...
Manage custom hostname routes. [Guide →](/deploying/routes)
...
| Flag | Type | Default | Description |
|------|------|---------|-------------|
| `--repo` | string | auto-detected | Git repo URL |
| `--branch` | string | — | Git branch |
| `--no-repo` | bool | `false` | Skip repo detection |
...
Show monitoring dashboard URLs. [Guide →](/managing/dashboard)
